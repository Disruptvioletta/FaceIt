...
class FaceView: UIView {
    ...
    @IBInspectable var inspectableLW: CGFloat = 5.0 {
        didSet {
            leftEye.lineWidth = inspectableLW
            rightEye.lineWidth = inspectableLW
            setNeedsDisplay()
        }
    }
